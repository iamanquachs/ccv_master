...
class KhachHang extends database
{
    ...
    {
        $getall = $this->connect->prepare("INSERT INTO khachhang(msdv,tendv,msdn,msctv,ngay,mskh,tenkh,dienthoai,diachi,trangthai,lydo,create_at)
        VALUES ('$msdv','$tendv','$msdn','$msctv','$ngay','$mskh','$tenkh','$dienthoai','$diachi','$trangthai','$lydo',NOW())");
        $getall->execute();
    }
