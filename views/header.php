...
<head>
    <base href="https://localhost/ccv-master/">
    <meta charset="utf-8">
        ...
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3" style="font-family: 'Nunito'"><?= $_COOKIE['ID_VPCC'] ?> <?= date('Y') ?> <sup>CRM</sup></div>
                </a>
                ...
                <li class="nav-item ">
                    <a href="vpcc" class="nav-link" href="charts.html">
                        <i class="fas fa-fw fa-user"></i>
                        <span>Tổ chức HNCC</span></a>
                </li>
                <li class="nav-item">
                    <a href="ccv" class="nav-link">
                        <i class="fas fa-fw fa-user"></i>
                        <span>Công chứng viên</span></a>
                </li>
                <li class="nav-item">
